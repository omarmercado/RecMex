...
public class NewArticuloCasoController extends AbstractController{
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		map.put("casoId" ,request.getParameter("casoId"));
		
		articulosDAO.newArticuloCaso(map);
				
		ModelAndView mv = new ModelAndView("redirect:/VerCaso.htm?casoId="+map.get("casoId"));
