...
<title>RecPolitica : Nuevo Caso</title>
...
<form:form  method="post"  commandName="NuevoCasoForm">
<table>
  <tr>
    <td>
    Titulo 
  ...
  <tr>
    ...
    <td>
    <form:input path="imagen" maxlength="254"/>
    </td>
  </tr>
 <tr>
    <td>
  ...
  <tr>
    <td>
    <input type="submit" value="Nuevo Caso">
    </td>
  </tr>
</table>
</form:form>
